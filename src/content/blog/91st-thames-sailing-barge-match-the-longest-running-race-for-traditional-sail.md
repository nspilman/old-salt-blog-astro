...
With pauses only for economic recessions and world wars, the [Thames Sailing Barge Match](https://thamesmatch.co.uk/) has been sailing ever since. Earlier this month, the [91st Thames Sailing Barge Match](https://thamesmatch.co.uk/?p=1420) was sailed with seven barges in three classes. The competitors ranged in age from two 125 year old barges, the [*Wyvenhoe*](https://en.wikipedia.org/wiki/SB_Wyvenhoe) and the [*Niagara*](https://en.wikipedia.org/wiki/SB_Niagara), to the relatively new [*Blue Mermaid*](https://en.wikipedia.org/wiki/Blue_Mermaid) built in 2019, which was the first to cross the finish line in this year’s race.
...
According to the [Society for Sailing Barge Research](https://www.sailingbargeresearch.org.uk/), 4,860 barges were built for trade from the 18th century to World War I. There were maybe [8,000 in all, including smaller vessels](https://www.washingtonpost.com/world/2023/07/24/thames-barges-british-history/) that were unregistered. Only a [relative handful have survived.](https://en.wikipedia.org/wiki/List_of_active_Thames_sailing_barges)

The *Blue Mermaid* is particularly notable as it is [the first sailing barge built for trade in Britain since 1930](https://www.oldsaltblog.com/2019/09/blue-mermaid-a-new-thames-sailing-barge/). Her design is based on a sailing barge of the same name, one of seven steel-hulled Thames barges built between 1925 and 1930 for F W Horlock. The original *Blue Mermaid* was sunk by a mine in World War II.

In 2023, the new *Blue Mermaid* was granted [permission by the the Maritime and Coastguard Agency to carry cargoes](https://www.oldsaltblog.com/2023/03/update-thames-sailing-barge-blue-mermaid-authorized-to-carry-cargo-in-the-thames/) of up to 110 tonnes, between Lowestoft and Sandwich – and up the Thames, becoming the first UK-registered sailing vessel to be authorized as a commercial cargo carrier since the 1970s.

The [Sea-Change Sailing Trust](https://seachangesailingtrust.org.uk/), which owns the *Blue Mermaid*, provides training and education for young people and vulnerable adults is working with Brightlingsea-based Essex Cement to carry cargo within its authorized range.

<iframe title="YouTube video player" src="https://www.youtube.com/embed/V1YnF4XfdOU" width="560" height="315" frameborder="0" allowfullscreen="allowfullscreen"></iframe>

[Thames, Sailing barge match 2023](https://youtu.be/V1YnF4XfdOU)
