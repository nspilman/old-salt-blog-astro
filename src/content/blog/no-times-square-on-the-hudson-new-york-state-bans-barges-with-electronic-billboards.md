...
While the lawsuit worked its way through the court system, [Sen. Brad Hoylman (D-Manhattan), took more direct action](https://nypost.com/2019/06/22/state-bans-floating-billboards-to-prevent-times-square-on-the-hudson/), sponsoring a bill in the Senate to ban the floating billboards. The bill passed the legislature and was signed by Gov. Andrew Cuomo on Tuesday. 

As reported by the [New York Post](https://nypost.com/2019/08/20/cuomo-signs-bill-restricting-floating-digital-billboards/amp/?__twitter_impression=true&fbclid=IwAR1tFedu2CJqqVUIxtAdLLO2X1oOsgIZ_a8_y2iPXBSkwVz77mnb736xCvg): Billboards on boats using “flashing, intermittent or moving lights” will be prohibited from operating, anchoring or mooring in the navigable waters of the state, but local governments will still have the authority to ban the vessels from operating, anchoring or mooring within 1,500 feet of the shoreline.
