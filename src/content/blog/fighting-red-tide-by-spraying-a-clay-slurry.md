...
As reported by [ILFS](https://www.iflscience.com/environment/slurry-of-clay-used-to-fight-against-floridas-deathly-red-tide/), known as clay flocculation, the process involves spraying the water surface with a slurry of modified clay particles and seawater. The clay binds to the algae and sinks to the seabed. Eventually, the cells and toxins become buried. Many of the algal cells will also rupture when they make contact with the modified clay and die.

Researchers from Woods Hole Oceanographic Institute (WHOI), [Mote Marine Laboratory & Aquarium](https://mote.org/news/article/rapid-test-of-red-tide-mitigation-strategy-deployed-in-sarasota), and the University of Central Florida [recently rolled out](https://mote.org/news/article/rapid-test-of-red-tide-mitigation-strategy-deployed-in-sarasota) this method to the canals and coast of Florida as part of an [ongoing initiative](http://www.redtidemtdi.org/) that’s seen clay flocculation deployed at 25 other sites. 
...
“This is just the first of what we hope will be several upcoming trials of clay flocculation on active blooms in the wild,” Dr. Don Anderson, Senior Scientist at WHOI and Principal Investigator for this Initiative project, said in a [statement](https://mote.org/news/article/rapid-test-of-red-tide-mitigation-strategy-deployed-in-sarasota). 
...
<iframe title="YouTube video player" src="https://www.youtube.com/embed/Go9JPpITAWc" width="560" height="315" frameborder="0" allowfullscreen="allowfullscreen"></iframe>

[Mote researchers: Clay could kill red tide without damaging environment](https://youtu.be/Go9JPpITAWc)
