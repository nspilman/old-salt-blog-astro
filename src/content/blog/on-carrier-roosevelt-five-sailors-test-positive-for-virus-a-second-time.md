...
What does the apparent recurrence of the virus mean? It is difficult to tell. The immune response to the coronavirus is not well understood.  In March, [more than 140 coronavirus survivors retested positive](https://www.forbes.com/sites/alexandrasternlicht/2020/04/16/140-plus-coronavirus-survivors-retest-positive-for-disease-in-south-korea-raising-questions-about-immunity/#5919030218ad) for the disease in South Korea. After subsequent analysis, however, scientists blamed the nature of the testing itself for the results. There is no clear consensus thas to whether surviving the virus imparts immunity, [although it does seem likely](https://www.livescience.com/coronavirus-reinfections-were-false-positives.html). 

The five symptomatic sailors on the *Roosevelt* raise new concerns about immunity. It is also possible that [problems with testing resulted in false-negative results](https://www.the-scientist.com/news-opinion/false-negatives-in-quick-covid-19-test-near-15-percent-study-67451) in previous tests. Either alternative is worrisome as the carrier prepares to go to sea.
