...
One of the state’s largest salt depots in Newark is close to being out of salt.  The depot is run by [International Salt,](http://www.internationalsalt.com/index.html) a subsidiary of the [K+S Group](http://www.k-plus-s.com/en/), a German multinational, which is one of the world’s leading fertilizer suppliers and also the world’s leading producer of salt.  While International’s Salt’s Newark depot may be close to empty, they have a depot in Searsport, Maine, which reportedly has 40,000 tons of salt available.  The problem is that Searsport is roughly 400 miles to the northeast of Newark.

Here is where the Jones Act and the bulk carrier, [*Anastasia S*](http://www.marinetraffic.com/ais/details/ships/538002123/vessel:ANASTASIA_S), come in.   The *Anastasia S* is a 58,000 DWT bulk carrier which could have carried all the Seaport salt.   The story gets a bit muddled from here. OK, more than muddled.

The [Christian Science Monitor](http://www.csmonitor.com/USA/2014/0218/Big-winter-Snow-clearing-crews-live-hand-to-mouth-as-road-salt-runs-low-video) reported yesterday : “*In the meantime, New Jersey officials say a 40,000-ton shipment of salt remains stuck in port in Maine, due to a 1920 maritime law that requires ships to fly a US flag to deliver goods between American ports. According to Mr. Dee, state officials have not been able to obtain a waiver for the law, so the salt, now on the Anastasia S, registered in the Marshall Islands, must be shipped to New Jersey by slow-moving barges.*”

[NJ.com](http://www.nj.com/news/index.ssf/2014/02/rock_salt_shipment_held_up_because_ship_is_not_flying_us_flag_report_sayd.html) has similar and sadly typical reporting, “*A large shipment of rock salt is not allowed to enter the Port of Newark because the ship does not fly an American flag*…”
...
The salt company has now arranged for a 9,500 DWT barge to carry the salt from Searsport, Maine, to Newark.  Unfortunately, the barge was delayed by the winter weather. The [first 9,500 tons of salt is expected to arrive in Newark next week](http://www.nj.com/news/index.ssf/2014/02/part_of_nj_salt_stockpile_on_maine_docks_to_arrive_in_newark_next_week.html).
