...
[A GAO Report](https://www.gao.gov/assets/710/707359.pdf) issued at roughly the same time as the Navy announcement has a somewhat different view.
...
[Task and Purpose](https://taskandpurpose.com/military-tech/uss-gerald-r-ford-aircraft-carrier-gao-rep) reports that the advanced weapons elevators aren’t the only critical systems facing major issues: According to the report, the electromagnetic aircraft launch system (EMALS) and Advanced Arresting Gear (AAG) that make up the Ford’s next-generation aircraft launch and retrieval capabilities are still deeply unreliable.
...
And then there is a [problem with the toilets](http://www.oldsaltblog.com/2020/03/uss-gerald-r-ford-clogged-toilets-and-overflowing-costs/). The toilets and the entire sewage system tends to get easily clogged. When this happens, the Navy has to flush the system with acid to clear it at a reported cost of $400,000. How often does this happen? The GAO says that the Navy cannot say.
