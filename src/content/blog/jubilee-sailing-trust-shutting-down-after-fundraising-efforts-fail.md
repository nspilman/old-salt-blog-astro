...
The SV *Tenacious* is a modern British wooden sail training ship, specially designed in the 1990s. When completed in 2000, it was the largest wooden ship to be built in the UK for over 100 years. Along with the [STS](https://en.wikipedia.org/wiki/STS_Lord_Nelson) *Lord Nelson,* the two vessels are the only tall ships in the world that were built so that both disabled and non-disabled people can sail as crew, not passengers.  The *Lord Nelson* was put up for auction in June of 2023. 

  
From the [Jubilee Sailing Trust announcement](https://jst.org.uk/): 
