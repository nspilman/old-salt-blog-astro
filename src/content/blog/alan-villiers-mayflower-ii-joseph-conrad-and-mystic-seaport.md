...
While not a particular believer in ghosts, if the ghost of [Alan Villiers](http://en.wikipedia.org/wiki/Alan_Villiers) is about, I suspect that he must smiling.  The arrival of the [*Mayflower II*](http://en.wikipedia.org/wiki/Mayflower_II) at [Mystic Seaport Museum](http://www.mysticseaport.org/) is the reunion, of sorts, of two ships long associated with the sailing ship captain and pioneer in sail training.   In mid December, the *Mayflower II* was towed from Plymouth, MA to the Henry B. duPont Preservation Shipyard at Mystic Seaport in Connecticut where she will begin the first phase of a multi-year restoration.
