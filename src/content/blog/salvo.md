...
*[Salvo!](http://www.shrapnelgames.com/SprueGames/SVO/SVO_page.html) is a turn based wargame covering naval warfare from the seventeenth through nineteenth centuries. Players can command a wide variety of ship types and do battle amongst all the major seafaring powers of the eras along with treacherous pirate scum. Campaign and scenario based, Salvo! also supports a thorough suite of editing tools that allow gamers to modify/create ships and scenarios. Additionally, players can do battle against live opponents even cross platform (PC versus Mac gamers).*  
