...
“We are aware of an incident concerning two minehunters alongside in Bahrain. There are no casualties as a result of this incident and it would be inappropriate to comment further whilst investigations are ongoing,” a spokesperson for the Ministry of Defence told the [BBC](https://www.bbc.com/news/uk-68040614).

This is the [second time that HMS *Chiddingfold* has been involved in such an incident](https://www.forces.net/news/navy-ships-collision-gulf-causes-ps100000-damage). In 2021, also off the coast of Bahrain, it struck [HMS *Penzance*](https://en.wikipedia.org/wiki/HMS_Penzance_\(M106\)), a ship of the same class as HMS *Bangor*.
...
<iframe title="YouTube video player" src="https://www.youtube.com/embed/cJmj-LUQliQ?si=fhyTEUai1eCbzmyq" width="560" height="315" frameborder="0" allowfullscreen="allowfullscreen"></iframe>

Thanks to [Alaric Bond](https://alaricbond.com/) and Larry Witmer for contributing to this post.
