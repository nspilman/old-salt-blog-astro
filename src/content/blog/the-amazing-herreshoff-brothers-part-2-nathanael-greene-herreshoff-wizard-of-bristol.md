...
Nathanael Herreshoff’s designs were often well ahead of their time. In 1876, Nat Herreshoff designed the [catamaran yacht *Amaryllis*](https://en.wikipedia.org/wiki/Amaryllis_\(catamaran\)) which won that year’s New York Centennial Regatta.  Following the victory, multihulls were banned from organized sailing competitions. In 1891, Herreshoff’s *[Dilemma](http://iscc.marinersmuseum.org/watercraft/dilemma/)* featured a fin keel with a streamlined bulb and a spade rudder.  The design won ever race it entered and was significantly influential. Over 100 more fin keel yachts were built within the next few years. In 1897, many yacht clubs adopted measurement rules that penalized the design in the attempt to make other boats competitive.

In 1902, Captain Nat developed the “Herreshoff Rule,” later called the [Universal Rule](https://en.wikipedia.org/wiki/Universal_Rule), which was used for rating yacht’s in the [America’s Cup](https://en.wikipedia.org/wiki/America%27s_Cup "America's Cup") from 1914 to 1937.
