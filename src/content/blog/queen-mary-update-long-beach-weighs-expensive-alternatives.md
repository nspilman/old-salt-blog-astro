...
The [LA Times](https://www.latimes.com/business/story/2021-07-20/long-beach-considers-options-for-queen-mary) reports that the council was presented with three options to consider:
...
The costs were calculated by [Moffatt & Nichol](https://www.moffattnichol.com/), the marine engineering firm hired by the city to evaluate the repairs needed for the ship. A detailed study of more immediate repairs is expected in the next few weeks. Teams are inspecting the hull, the metal thickness, and the fire suppression system on the ship, according to a city report.

The [Press-Telegram](https://www.presstelegram.com/2021/07/20/long-beach-explores-options-for-queen-marys-future-including-preservation-or-disposal/) noted council support for saving the ship, though council members and city officials all acknowledged that the best way to achieve that end is still unclear.

Not only would Long Beach have to pay the costs \[of scrapping or sinking the ship\], City Manager Tom Modica said, but the city would also lose out on all the potential revenue the *Queen Mar*y could generate in the years to come.
