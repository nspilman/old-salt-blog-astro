...
When she wrote her thoughts on the timelessness of the North Pole, Katie Weeman was working as communications support for the [icebreaking research vessel *Polarstern*](http://www.oldsaltblog.com/2020/08/icebreaker-makes-unplanned-open-water-arctic-detour/), which she describes as “deliberately locked in ice for a year to measure all aspects of that ice, the ocean beneath it and the sky above.”  
...
Of course, time is more than the movement of a minor planet in one of a myriad of solar systems. Scientists now define time by the [unperturbed ground-state hyperfine transition frequency of the caesium-133 atom](https://en.wikipedia.org/wiki/Second#International_second).  And according to Einstien’s theory of relativity, time doesn’t exist independently but is part of [spacetime](https://en.wikipedia.org/wiki/Spacetime#:~:text=In%20physics%2C%20spacetime%20is%20any,where%20and%20when%20events%20occur.), a single four-dimensional manifold.  
