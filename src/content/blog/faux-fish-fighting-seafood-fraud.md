...
Fish fraud has long been a known problem worldwide. Because seafood is among the most internationally traded food commodities, often through [complex and opaque supply chains](https://www.pnas.org/content/117/48/30318#sec-1), it is highly vulnerable to mislabelling. Much of the global catch is transported from fishing boats to huge transshipment vessels for processing, where mislabelling is relatively easy and profitable to carry out.

[Oceana](https://usa.oceana.org/), an international organization focused on oceans, notes that today, more than 90 percent of the seafood consumed in the U.S. is imported, and [less than 1 percent is inspected by the government specifically for fraud](https://oceana.org/sites/default/files/National_Seafood_Fraud_Testing_Results_Highlights_FINAL.pdf). With more than 1,700 different species of seafood from all over the world available for sale in the U.S., it is unrealistic to expect the American consumer to be able to independently and accurately determine what they are actually eating.
