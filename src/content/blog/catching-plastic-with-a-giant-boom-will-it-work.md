...
The 2,000-foot-long unmanned structure was the product of about $20 million in funding from [Ocean Cleanup](https://www.theoceancleanup.com/), a nonprofit. They hope to trap up to 68 metric tonnes of plastic during the boom’s first year at sea. The concept is to use the ocean winds and currents to passively collect and concentrate drifting plastics, which would then be collected by ships and carried to shore for disposal or recycling. The boom has an impenetrable skirt that hangs nearly 10 feet below to catch smaller pieces of plastic.     

Over the last five years of development, the design has evolved. The original anchored boom network is now [designed to drift](https://www.theoceancleanup.com/technology/). The goals have are also somewhat more limited. The organization now hopes to clean half of [the Great Pacific Garbage Patch](https://www.nytimes.com/2018/03/22/climate/great-pacific-garbage-patch.html) within five years, still a highly aggressive target.
...
The [NY Times](https://www.nytimes.com/2018/09/09/science/ocean-cleanup-great-pacific-garbage-patch.html) quotes George Leonard, chief scientist at the Ocean Conservancy, “There’s worry that you can’t remove the plastic without removing marine life at the same time. We know from the fishing industry if you put any sort of structure in the open ocean, it acts as a fish-aggregating device.”
...
Others question whether the focus on removing plastic in the ocean is less effective than preventing plastics from reaching the oceans in the first place. Each year an estimated [8 million metric tons of plastic](https://www.earthday.org/2018/04/05/fact-sheet-plastics-in-the-ocean/) are dumped into the ocean. [Scientific American](https://www.scientificamerican.com/article/stemming-the-plastic-tide-10-rivers-contribute-most-of-the-plastic-in-the-oceans/) notes that a recent study estimates that more than a quarter of all that waste could be pouring in from just 10 rivers, eight of them in Asia.

<iframe src="https://www.youtube.com/embed/II1VHaURRlA" width="560" height="315" frameborder="0" allowfullscreen="allowfullscreen"></iframe>

[Ocean Cleanup Launched A Plastic Catcher | CNBC](https://youtu.be/II1VHaURRlA)
