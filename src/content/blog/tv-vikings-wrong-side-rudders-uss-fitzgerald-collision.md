...
[Vikings](http://www.imdb.com/title/tt2306299/episodes) is a [History Channel series](http://www.imdb.com/title/tt2306299/episodes) that follows the exploits of  the legendary Viking leader Ragnar Lodbrok. It is basically lots of fun, with swords and axes flying, supported by a fair share of intrigue and drama, the sort of show that will tide Game of Thrones fans over until that series finally starts again.
...
When the container ship approached the [USS *Fitzgerald*](http://www.oldsaltblog.com/2017/06/destroyer-uss-fitzgerald-nearly-sank-following-collision-seven-sailors-died-deck/) from the starboard side, all else being equal, the Navy ship had the responsible to maneuver to avoid a collision.  (This did not absolve the container ship from responsibility for maintaining a lookout or of doing everything possible to avoid an imminent collision.)  
