...
This is an odd story, set in the icy Siberian waters near Murmansk, Russia.  Apparently, Russia’s largest floating drydock sank from underneath Russia’s only aircraft carrier, the [*Admiral Kuznetsov*](https://en.wikipedia.org/wiki/Russian_aircraft_carrier_Admiral_Kuznetsov), doing some damage to the carrier above the waterline as the dock sank. The carrier was undocking when a reported power failure caused the dock to flood and ultimately sink. Reportedly, one person died and four were injured.

### The Sinking Floating Dry Dock

Here is where it gets odd.  One account in the [Drive](http://www.thedrive.com/the-war-zone/24572/russias-dry-dock-accident-could-have-far-larger-repercussions-than-a-damaged-carrier) blog suggests that Russia’s dry dock accident could have far larger repercussions than a damaged carrier. The drydock, designated PD-50, is the largest Russian floating dock and according to Drive the only Russian dry dock that we know of that could handle the country’s lone aircraft carrier.

On the other hand, the [Diplomat](https://thediplomat.com/2018/10/one-of-the-worlds-largest-floating-dry-docks-has-sunk-with-russias-carrier-aboard/) blog says that shipyard reportedly possesses another floating dock, PD-1, of approximately identical size to the one sunk. 

Which report is correct? [Subsequent news accounts](https://arstechnica.com/tech-policy/2018/11/russian-officials-nope-we-cant-finish-fixing-the-carrier-kuznetsov/) suggest that the PD-1 can handle every other Russian Navy ship except the [*Kuznetsov.*](https://en.wikipedia.org/wiki/Russian_aircraft_carrier_Admiral_Kuznetsov) There are also other reports that the Russians have large dry docks in the Black Sea and the Pacific, which may not be geographically convenient, but are nevertheless available if need be. 
