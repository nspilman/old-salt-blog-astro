...
Originally posted on [gCaptain](https://gcaptain.com/warning-rogue-wave-ahead-predicting-the-ship-killing-waves/) by Rick Spilman, on March 3, 2016. Reposted with permission.

[Rogue waves](https://en.wikipedia.org/wiki/Rogue_wave) are real sea monsters. Rising many times higher than surrounding waves, they have the power to sink ships and to cripple offshore platforms. Recently, [engineers from MIT have developed a new means of predicting](http://news.mit.edu/2016/prediction-tool-rogue-waves-0225) the formation of rogue waves, which may give mariners a two to three-minute warning before one of the monster wave hits.
...
The algorithm is said to be capable of providing a several minute warning to officers on ships or drilling platforms that a rogue wave is forming. To make it work, the ship or platform would need high-resolution scanning devices such as [LIDAR](https://en.wikipedia.org/wiki/Lidar) or advanced radar to scan the surrounding waves. Additional research and testing will be required, but the initial work appears promising.
...
<iframe src="https://www.youtube.com/embed/xgALuj6WUbk" width="560" height="315" frameborder="0" allowfullscreen="allowfullscreen"></iframe>

[New prediction tool gives warning of incoming rogue waves](https://youtu.be/xgALuj6WUbk)
