...
tags:
  ...
  - "Maud"
  - "Roald Amundsen"
featuredImage: "https://old-salt-blog-media.s3.us-east-2.amazonaws.com/uploads/2018/06/maudtow.jpg"
author: "Rick Spilman"
...
For several years, we have been [following the attempts to raise](http://www.oldsaltblog.com/2016/08/lifting-maud-mud-amundsens-ship-floats/) Arctic explorer Roald Amundsen‘s [research ship *Maud*](https://en.wikipedia.org/wiki/Maud_\(ship\)) from where it has been sitting in ice and mud for close to 90 years. To say that the conditions in Cambridge Bay off the Nunavut territory of northern Canada have been challenging would be an understatement. Over the last eight summers, a [team of Norwegians has been working to raise and ultimately return *Maud* back to Norway](http://www.maudreturnshome.no/uncategorized/maud-returns-home-hometrip/). In the summer of 2017, they achieved a major milestone — successfully towing the Maud on the barge Jensen out of  Cambridge Bay to Aasiaat on West Greenland. They are now preparing for the final leg of the journey.
