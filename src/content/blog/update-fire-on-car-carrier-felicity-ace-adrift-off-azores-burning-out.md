...
Car carrier fires, particularly involving lithium-ion batteries in electric vehicles, can be especially difficult to extinguish. Lithium-ion batteries may catch fire if damaged or due to a manufacturing flaw and can burn extremely hot.  [Firefighters have found that they needed to flow large amounts of water](https://www.firerescue1.com/firefighter-training/articles/what-firefighters-need-to-know-about-electric-car-batteries-omiDv8vd87oZ9ZKs/) on the batteries because fire kept flaring up even after it appeared to be extinguished.

On average, [electric vehicles are far less likely to catch fire than gasoline-powered cars](https://ndakotalaw.com/do-electric-cars-catch-fire-more-than-gas-powered-vehicles/). Recent analysis suggests that electric vehicles suffer 25 fires per 100,000, as compared to 1,529 fires per 100,000 vehicles. Hybrids, with both batteries and gasoline engines, have the highest rate of fires at 3,474 fires per 100,000.  
...
Several car carriers have capsized due to inadequate stability in normal operations. The most recent example being the [*Golden Ray*](https://www.oldsaltblog.com/2021/09/golden-ray-the-billion-dollar-blunder-tallying-the-cost/), which lost stability and rolled on its side in St. Simons Sound near the Port of Brunswick in Georgia, due to an error in a stability calculation prior to sailing.
